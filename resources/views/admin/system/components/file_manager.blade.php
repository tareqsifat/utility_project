<!-- Modal -->
<div class="modal fade" id="fileManagerModal" tabindex="-1" aria-labelledby="fileManagerModalLebel" area-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="fileManagerModalLebel">File Manager</h5>
                            ...
                            <div class="card-body">
                                ...
                                <div class="fm-menu">
                                    <div class="list-group list-group-flush">
                                        ...
                                        <a href="javascript:;" class="list-group-item py-1"><i class="icon-trush icons"></i><span>Deleted Files</span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="fm-search">
                                    <div class="mb-0">
                                        <div class="input-group input-group-lg">
                                            ...
                                            <input type="text" class="form-control" placeholder="search the file">
                                        </div>
                                    </div>
                                </div>
                            </div>
